class Product {
  constructor(name, price, inStock, quantity) {
    if (this.constructor === Product) {
      throw new Error("Class is an abstract type and can't be instantiated");
    }
  ...
  order(quantity) {
    if (quantity < 1 || this.quantity < quantity) return false;
...
// const product = new Product("USB C Cable", 10, 100, true); - can't instantiate an abstract class
...
console.log(adidas.order(-10)); // false
